	...
	render() {
		...
		return (
			<div className={classString}>
				...
				<input type="text" className="logInCreatorText" name="logInUsername" placeholder="Username" rows="1" ref="username"></input>
				<input type="password" className="logInCreatorText" name="logInPassword" placeholder="Password" rows="1" ref="password"></input>
